...
# https://www.kaggle.com/emilyhorsman/basic-logistic-regression-with-numpy/data
...
def main():
    ...
    predictPercentage = len(list(filter(lambda x: x[0] == x[1], np.dstack((predictions, y_test))[:,0]))) / len(predictions)
